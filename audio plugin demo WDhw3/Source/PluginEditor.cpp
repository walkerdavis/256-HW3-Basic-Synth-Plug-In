      ...
      
{
  ...
  //  audioDeviceManager.addAudioCallback (&audioSourcePlayer);
    ...
    gain_slider.setRange(0., 127.);
    gain_slider.setTextBoxStyle(Slider::TextEntryBoxPosition::NoTextBox, true, 0, 0);
    ...
    //gainLabel.attachToComponent (gain_slider, false);
...
void JuceDemoPluginAudioProcessorEditor::resized()
{
    ...
    midiInputList.setBounds (labelWidth, 0, r.getWidth()-labelWidth, 20);
    midiKeyboard.setBounds (0, 30, r.getWidth(), 64);
        ...
        gain_slider.setBounds (sliderArea.removeFromLeft (jmin (180, sliderArea.getWidth() / 2)));
