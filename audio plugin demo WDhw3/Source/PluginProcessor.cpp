...
public:
    SineWaveVoice()
        : angleDelta (0.0),
            ...
            tailOff(true)
    {
        sawtone.init(getSampleRate());
        sawtone.buildUserInterface(&sawControl);
                    ...
                    int /*currentPitchWheelPosition*/) override
    {
        ...
        sawControl.setParamValue("/sawtone/freq", MidiMessage::getMidiNoteInHertz(midiNoteNumber));
        
        sawControl.setParamValue("/sawtone/gain", velocity);
        sawControl.setParamValue("/sawtone/trigger", 1);
...
//
    void stopNote (float /*velocity*/, bool allowTailOff) override
    {
        ...
        sawControl.setParamValue("/sawtone/trigger", 0);
...
//        }
    ...
    void controllerMoved (int controllerNumber, int newValue) override
    {
        if (controllerNumber == 2) {
            float gain = (float)newValue/127;
            DBG("gain: " << gain); 
            sawControl.setParamValue("/sawtone/gain", gain);
        }
...
//    }
    void renderNextBlock (AudioSampleBuffer& outputBuffer, int startSample, int numSamples) override
    {
        ...
        if(envelope != 0 || onOff) {
            ...
            //level = midiNote velocity
            
            audioBuffer[0] = new float[numSamples];
            audioBuffer[1] = new float[numSamples];
            sawtone.compute(numSamples, NULL, audioBuffer);
            DBG("Buffer: " << audioBuffer[0][0]);
            envelope = audioBuffer[1][0];
            
            
            //would have liked to incude these, could not get "gain" to work
            
            //set faust parameters here
            //            sawControl.setParamValue("/sawtone/gain", envelope);
            //            sawControl.setParamValue("/sawtone/cutoff", cutoff);
            //            sawControl.setParamValue("/sawtone/reso", resonance);
            //            sawControl.setParamValue("/sawtone/attack", attack);
            //            sawControl.setParamValue("/sawtone/decay", decay);
            //            sawControl.setParamValue("/sawtone/sustain", sustain);
            //            sawControl.setParamValue("/sawtone/release", release);
...
//    }
    ...
    Sawtone sawtone;
    MapUI sawControl;
    double currentAngle, angleDelta, level, envelope;
    bool  onOff,tailOff;
    float **audioBuffer;
